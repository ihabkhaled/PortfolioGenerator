...
export const portfolioShellClasses = {
  root: '@container/portfolio min-h-dvh bg-canvas text-foreground',
  header:
  ...
  headerInner:
    'mx-auto grid min-h-16 max-w-[90rem] grid-cols-[auto_minmax(0,1fr)_auto] items-center gap-x-3 px-5 py-2 @3xl/portfolio:px-8 @5xl/portfolio:grid-cols-[auto_minmax(10rem,0.75fr)_minmax(0,auto)_auto] @5xl/portfolio:gap-x-5 @5xl/portfolio:px-10',
  ...
  brandHeadline:
    'hidden truncate font-mono text-[0.625rem] font-medium uppercase tracking-[0.12em] text-muted-foreground @7xl/portfolio:block',
  // The horizontal bar is a wide-container affordance; narrower render
  // surfaces get their own collapsible menu (`navToggle`/`mobileNav`
  ...
  // the desktop width.
  nav: 'scroll-fade-x hidden min-w-0 items-center justify-center gap-0.5 overflow-x-auto overflow-y-hidden [scrollbar-width:none] @5xl/portfolio:flex [&::-webkit-scrollbar]:hidden',
  navLink:
    'relative inline-flex min-h-10 cursor-pointer items-center gap-1.5 rounded-md px-2.5 py-2 text-[0.8125rem] font-medium whitespace-nowrap text-muted-foreground transition-colors hover:bg-muted hover:text-foreground focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ring @7xl/portfolio:px-3 @7xl/portfolio:text-sm',
  navLinkCurrent:
  ...
  // The hamburger toggle exists below the same container width where `nav`
  // disappears, so exactly one of the two navigation
  // affordances is ever on screen at once.
  navToggle:
    'inline-flex size-11 shrink-0 cursor-pointer items-center justify-center rounded-md text-foreground transition-colors hover:bg-muted focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ring @5xl/portfolio:hidden',
  ...
  mobileNav:
    'absolute inset-x-0 top-full z-40 grid gap-1 border-b border-border bg-canvas px-5 py-3 shadow-lg @5xl/portfolio:hidden',
  mobileNavLink:
  ...
  main: 'mx-auto w-full max-w-6xl px-5 pb-[5.5rem] @3xl/portfolio:px-8 @5xl/portfolio:px-10',
  footer: 'mt-24 border-t border-border bg-surface/40 print:hidden',
  footerInner:
    'mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-6 px-5 py-12 @3xl/portfolio:px-8 @5xl/portfolio:px-10',
  footerNote: 'font-mono text-[0.6875rem] uppercase tracking-[0.12em] text-muted-foreground',
  footerNoteLink:
    'inline-flex min-h-6 items-center underline-offset-4 transition-colors hover:text-foreground hover:underline focus-visible:text-foreground focus-visible:underline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ring',
  footerLink:
    'inline-flex min-h-6 items-center text-sm text-muted-foreground underline-offset-4 transition-colors hover:text-foreground hover:underline',
} as const;

export const portfolioSectionClasses = {
  /** Prevent viewport breakpoints from leaving the editor's narrow preview in desktop rails. */
  page: 'mx-auto w-full max-w-6xl px-5 @3xl/portfolio:px-8 @5xl/portfolio:px-10 @max-4xl/portfolio:[&>section]:grid-cols-1 @max-4xl/portfolio:[&>section]:gap-4 @max-4xl/portfolio:[&>section]:py-10 @max-4xl/portfolio:[&>section>p]:pt-0 @max-4xl/portfolio:[&>section>div>h2]:text-2xl @max-4xl/portfolio:[&>section>div>div]:pt-6',
} as const;
...
export const heroClasses = {
  wrapper:
    'relative -mx-5 overflow-hidden border-b border-border @3xl/portfolio:-mx-8 @5xl/portfolio:-mx-10',
  grid: 'surface-grid pointer-events-none absolute inset-0',
  inner:
    'relative mx-auto grid max-w-5xl gap-10 px-5 py-16 @3xl/portfolio:px-8 @3xl/portfolio:py-20 @5xl/portfolio:grid-cols-[minmax(0,1.4fr)_minmax(0,1fr)] @5xl/portfolio:items-center @5xl/portfolio:gap-14 @5xl/portfolio:px-10 @5xl/portfolio:py-24',
  content: 'grid gap-5',
  portraitFrame:
    'size-24 overflow-hidden rounded-full border border-border bg-surface-raised @3xl/portfolio:size-28',
  ...
  name: 'font-display text-4xl font-bold leading-[1.0] tracking-[-0.035em] text-balance @3xl/portfolio:text-5xl @5xl/portfolio:text-6xl',
  headline:
    'font-display text-lg font-medium tracking-tight text-muted-foreground @3xl/portfolio:text-xl',
  summary: 'max-w-xl leading-relaxed text-foreground text-pretty',
  actions: 'flex flex-wrap items-center gap-3 pt-1',
  socialRow: 'flex flex-wrap items-center gap-x-5 gap-y-2 border-t border-border pt-4',
  socialLink:
...
export const timelineClasses = {
  ...
  item: 'grid gap-4 px-5 py-7 @3xl/portfolio:px-7',
...
export const projectClasses = {
  ...
  list: 'columns-1 gap-4 @3xl/portfolio:columns-2',
  item: 'mb-4 grid break-inside-avoid content-start gap-3 rounded-lg border border-border bg-surface-raised p-5',
...
export const skillsClasses = {
  list: 'grid grid-cols-[repeat(auto-fit,minmax(min(100%,18rem),1fr))] gap-px overflow-hidden rounded-lg border border-border bg-border',
...
export const factListClasses = {
  list: 'divide-y divide-border overflow-hidden rounded-lg border border-border bg-surface-raised',
  item: 'grid gap-1 px-5 py-5 @3xl/portfolio:px-7',
  head: 'flex flex-wrap items-baseline justify-between gap-x-6 gap-y-1',
...
export const contactClasses = {
  panel:
    'grid gap-6 rounded-lg border border-border bg-surface-raised px-6 py-8 @3xl/portfolio:px-8',
  rows: 'grid gap-3',
...
export const customBlockClasses = {
  ...
  statList:
    'grid gap-px overflow-hidden rounded-lg border border-border bg-border @3xl/portfolio:grid-cols-3',
...
export const supplementalClasses = {
  ...
  quotes: 'grid gap-4 @3xl/portfolio:grid-cols-2',
  ...
  gallery: 'grid gap-4 @3xl/portfolio:grid-cols-2',
