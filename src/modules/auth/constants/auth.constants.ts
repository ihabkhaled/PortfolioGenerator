...
export const AUTH_INITIAL_FORM_STATE: AuthFormState = {
  status: 'idle',
  error: null,
  notice: null,
};
...
export const AUTH_NOTICE_KEYS = {
  verificationEmailSent: 'notices.verificationEmailSent',
  emailNotVerified: 'notices.emailNotVerified',
} as const;
