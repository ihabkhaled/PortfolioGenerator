...
export const siteShellClasses = {
  ...
  headerInner:
    'mx-auto flex min-h-16 max-w-6xl flex-wrap items-center justify-between gap-2 px-5 py-2 sm:gap-4 sm:px-8 lg:px-10',
  ...
  navLink:
    'inline-flex min-h-11 cursor-pointer items-center rounded-md px-2.5 py-2 text-sm font-medium whitespace-nowrap text-muted-foreground transition-colors hover:text-foreground focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ring',
